                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{!! $cat->slug !!}</td>
                                <td class="d-flex">
                                    <a href="{{ route('category.edit', $cat->id) }}" class="waves-effect waves-float btn-sm waves-green text-black mr-2"><i class="zmdi zmdi-edit" style="line-height: 1.8;"></i></a>
                            ...
                            <tr>
                                ...
                                <td>{!! $subcat->slug !!}</td>
                                <td class="d-flex">
                                    <a href="{{ route('category.edit', $subcat->id) }}" class="waves-effect waves-float btn-sm waves-green text-black mr-2"><i class="zmdi zmdi-edit" style="line-height: 1.8;"></i></a>
                            ...
                            <tr>
                                ...
                                <td>{!! $cat->slug !!}</td>
                                <td class="d-flex">
                                    <a href="{{ route('category.edit', $cat->id) }}" class="waves-effect waves-float btn-sm waves-green text-black mr-2 edit-btn"><i class="zmdi zmdi-edit" style="line-height: 1.8;"></i></a>
                                    <form class="d-inline" method="POST" action="{{ route('category.destroy', $cat->id) }}">
                                        @csrf
                                        @method('DELETE')
                                        <button class="waves-effect waves-float btn-sm waves-red text-black border-0"><i class="zmdi zmdi-delete" style="line-height: 1.8;"></i></button>
