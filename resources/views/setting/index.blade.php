...
<div class="container-fluid">
    ...
    <div class="row clearfix profile-edit"> 
        ...
        <form action="{{ route('setting.update', $setting->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-sm-12">
                @if(count($errors) > 0)
                    <span style="color: red; width: 100%; text-align: right;">Something wrong - you have to fill all required fileds. </span>
                @endif
                <div class="card">
                    <div class="body">
                                                ...
                                                <div class="form">
                                                    <div class="form-group d-lg-flex align-items-start">
                                                        ...
                                                        <textarea rows="4" class="form-control no-y" id="site-des"
                                                            placeholder="Site description" name="description">{{ old('description') ? old('description') : $setting->description }}</textarea>
                                                    </div>
                                                    <div class="form-group d-lg-flex align-items-start">
                                                        <label for="site-meta">Meta keyword</label>
                                                        <textarea rows="4" class="form-control no-y" id="site-meta"
                                                            placeholder="Meta keyword" name="meta_key" >{{ old('meta_key') ? old('meta_key') : $setting->meta_key }}</textarea>
                                                    </div>
                                                    <div class="form-group d-lg-flex align-items-start">
                                                        <label for="copyright">Footer Copyright</label>
                                                        <textarea rows="4" class="form-control no-y summernote" id="copyright"
                                                            placeholder="Copyright" name="copyright" >{{ old('copyright') ? old('copyright') : $setting->copyright }}</textarea>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-lg-6">
                                                        ...
                                                        <input id="city" type="text" class="form-control"
                                                            placeholder="city" name="city" value="{{ old('city') ? old('city') : $setting->city }}">
                                                    </div>
                                                    <div class="form-group col-lg-6">
                                                        <label for="pos-code">Postal code</label>
                                                        <input id="pos-code" type="number" class="form-control"
                                                            placeholder="Postal code" name="post_code" value="{{ old('post_code') ? old('post_code') : $setting->post_code }}">
                                                    </div>
                                                    <div class="form-group col-lg-6">
                                                        <label for="state">State</label>
                                                        <input id="state" type="text" class="form-control"
                                                            placeholder="State" name="street" value="{{ old('street') ? old('street') : $setting->street }}">
                                                    </div>
                                                    <div class="form-group col-lg-6">
                                                        <label for="country">Country</label>
                                                        <input id="country" type="text" class="form-control"
                                                            placeholder="Country" name="country" value="{{ old('country') ? old('country') : $setting->country }}">
                                                    </div>
                                                    <div class="form-group col-lg-6">
                                                        <label for="email">Email</label>
                                                        <input id="email" type="email" class="form-control"
                                                            placeholder="Email" name="email" value="{{ old('email') ? old('email') : $setting->email }}">
                                                            @if($errors->has('email'))
                                                    ...
                                                    <div class="form-group col-12">
                                                        ...
                                                        <textarea rows="4" class="form-control no-y" id="site"
                                                            placeholder="Address" name="address"> {{ old('address') ? old('address') : $setting->address }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                ...
                                                                <input name="header_logo" type="file" class="dropify" data-default-file="{{ url($setting->header_logo) }}" value="{{ $setting->header_logo }}">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                ...
                                                                <input name="footer_logo" type="file" class="dropify" data-default-file="{{ url($setting->footer_logo) }}" value="{{ $setting->footer_logo }}">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <label>Favicon</label>
                                                                <input name="favicon" type="file" class="dropify" data-default-file="{{ url($setting->favicon) }}" value="{{ $setting->favicon }}">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                ...
                                                                <input name="preloader" type="file" class="dropify" name="preloader" data-default-file="{{ url($setting->preloader) }}" value="{{ $setting->preloader }}">
                                                ...
                                                <div class="row with-control">
                                                    <div class="col-12 mb-3">
                                                        <div class="input-group appendable">
                                                            ...
                                                            <input id="google-id" type="text" class="form-control timepicker" placeholder="Google Analytics ID" name="google_analytics_id" value="{{ old('google_analytics_id') ? old('google_analytics_id') : $setting->google_analytics_id }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-12 mb-3">
                                                        <div class="input-group appendable">
                                                            ...
                                                            <input id="publish-id" type="text" class="form-control timepicker" placeholder="Publisher ID" name="publisher_id" value="{{ old('publisher_id') ? old('publisher_id') : $setting->publisher_id }}">
                                                        </div>
                                                    </div>
                                                            <div class="form-group col-12">
                                                            <label for="google-map">Google map</label>
                                                            <textarea rows="4" class="form-control no-y" id="google-map"
                                                                placeholder="Google map" name="google_map">{{ old('google_map') ? old('google_map') : $setting->google_map }}</textarea>
                                                        </div>
                                                </div>
                                            </div>
